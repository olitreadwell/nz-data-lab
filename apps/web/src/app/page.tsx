        ...
        <Container size="wide">
          <Stack className="max-w-3xl gap-6 py-[var(--spacing-2xl)]">
            ...
            <p className="numeral-paragraph-lg text-[var(--color-muted)]">
              ...
              23.3 million by 2025. The series starts in 1994, the year the flock peaked. This page
              shows the real series, pulled from the Stats NZ Aotearoa Data Explorer at deploy time.
            </p>
          </Stack>
          ...
          <ClickToReveal buttonLabel="Reveal the sheep index" hideLabel="Hide the sheep index">
            ...
            <p className="numeral-paragraph-sm max-w-3xl pb-[var(--spacing-2xl)] text-[var(--color-muted)]">
              Data: Stats NZ Aotearoa Data Explorer, table AGR_AGR_003 (Livestock Numbers by
              Regional Council), national sheep total, fetched at deploy time via @nzlab/stats-nz,
              falling back to a committed snapshot when the API blocks the build runner; the site
              redeploys daily. Hover or drag across the chart to read the flock at any year. Table
              link:{' '}
              <a
                className="underline"
                href="https://www.stats.govt.nz/tools/aotearoa-data-explorer/"
              >
