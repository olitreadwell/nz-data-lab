...
Every microsite in `apps/web/src/app/experiments/` uses this package to fetch data. Server-side only (SDMX responses can be large; never call this from the browser).
